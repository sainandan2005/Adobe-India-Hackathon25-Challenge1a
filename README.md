...
## Overview
This repository contains the solution for **Challenge 1a** of the Adobe India Hackathon 2025 - "Connecting the Dots" challenge. The solution extracts structured outlines from PDF documents and outputs JSON files matching the required schema.
